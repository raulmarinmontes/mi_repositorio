...
(function ($) {
    $.fn.lightBox = function (settings) {
        settings = jQuery.extend({
            ...
            imageLoading: 'img/imagenes-galeria/lightbox-ico-loading.gif',
            imageBtnPrev: 'img/imagenes-galeria/lightbox-btn-prev.gif',
            imageBtnNext: 'img/imagenes-galeria/lightbox-btn-next.gif',
            imageBtnClose: 'img/imagenes-galeria/lightbox-btn-close.gif',
            imageBlank: 'img/imagenes-galeria/lightbox-blank.gif',
